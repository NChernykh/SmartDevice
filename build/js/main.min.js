...
/* harmony import */ var _modules_init_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-scroll */ "./js/modules/init-scroll.js");
/* harmony import */ var _modules_init_mask__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-mask */ "./js/modules/init-mask.js");
...
Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_3__["initAccordion"])();
Object(_modules_init_scroll__WEBPACK_IMPORTED_MODULE_4__["initScroll"])();
Object(_modules_init_mask__WEBPACK_IMPORTED_MODULE_5__["initMask"])();
...
var trigger = document.querySelectorAll('.footer__subtitle');
var parentElem = document.querySelector('.footer__top');

var initAccordion = function initAccordion() {
  var getItem = function getItem(elements, className) {
    var element;
  ...
  parentElem.addEventListener('click', function (event) {
    ...
    if (target && target.classList.contains('footer__subtitle')) {
      trigger.forEach(function (item, i) {
        var itemShow = getItem(trigger, 'footer__subtitle--show');
...
var initMask = function initMask() {
  ...
  var reg = /^[\d]{1}\ \([\d]{2,3}\)\ [\d]{2,3}-[\d]{2,3}-[\d]{2,3}$/;
  var im = new inputmask__WEBPACK_IMPORTED_MODULE_0___default.a('+7 (999) 999-99-99');
  im.mask(inputs);

  var validity = function validity(regEx, value) {
...
var inputFocus = modalFeedback.querySelector('[data-name]'); // аргументы setupModal(modal, closeCallback, modalBtns, openCallback, noPrevDefault, preventScrollLock)
...
var initModals = function initModals() {
  ...
  if (modalFeedback && modalFeedbackBtns.length) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalFeedback, false, modalFeedbackBtns, false, false, false, inputFocus);
  }
...
var anchors = [].slice.call(document.querySelectorAll('[data-scroll]')); // const animationTime = 600;
...
var openModal = function openModal(modal, callback, preventScrollLock, inputFocus) {
  if (inputFocus) {
    setTimeout(function () {
      inputFocus.focus();
    }, 500);
...
var setupModal = function setupModal(modal, closeCallback, modalBtns, openCallback, noPrevDefault, preventScrollLock, inputFocus) {
  if (modalBtns) {
